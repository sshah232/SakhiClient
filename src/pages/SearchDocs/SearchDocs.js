...
const SearchDocs = () => {
  // Set default location to New York City (USA)
  ...
  useEffect(() => {
    // Removed geolocation to always show USA-based doctors
    getDoctors();
  }, []);

  const getDoctors = async () => {
    const url = `https://api.mapbox.com/search/searchbox/v1/suggest?q=doctor&language=en&proximity=${lng},${lat}&country=us&session_token=02dcad2a-1890-4bc1-88ae-83109b80c3a9&access_token=${API_TOKEN}`;
